// Painel do Dono — layout com barra de tarefas XP na parte inferior que
// funciona como navegação entre abas (Agenda | Controles | Sair).
//
// A tabstrip interna foi removida (commit anterior) porque agora a taskbar
// nativa do XP cumpre esse papel — mais fiel ao estilo retrô e mais
// ergonômico (não escapa da tela).
...
export function OwnerPanel() {
  ...
  return (
    // Layout fullscreen: conteúdo flexível no topo, taskbar XP fixa embaixo
    <div className="fixed inset-0 flex flex-col bg-[#008080]">
      {/* Área de conteúdo — deixa espaço pra taskbar */}
      <div className="flex-1 flex items-center justify-center p-4 pb-2 overflow-auto">
        <Window
          title={`Painel do Dono — BunkerBarbershop`}
      ...
      {/* Taskbar XP — navegação entre abas + sair. Fixa embaixo da tela. */}
